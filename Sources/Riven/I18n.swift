...
enum I18n {
    ...
    static let dict: [String: (ko: String, en: String)] = [
        ...
        "chat.mcp.addBody": ("riven 이 내부에서 claude mcp add 를 실행해 추가하고 자동으로 재연결합니다.",
                             "riven runs claude mcp add internally and reconnects automatically."),
        "chat.mcp.addNamePh": ("이름 (예: github)", "name (e.g. github)"),
        "chat.mcp.addCmdPh": ("명령 또는 URL (예: npx -y @modelcontextprotocol/server-github)",
                              "command or URL (e.g. npx -y @modelcontextprotocol/server-github)"),
        "chat.mcp.adding": ("'{n}' 추가 중…", "Adding '{n}'…"),
