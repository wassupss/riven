...
enum I18n {
    ...
    static let dict: [String: (ko: String, en: String)] = [
        ...
        "chat.help": ("리븐 네이티브 채팅 · /clear 지우기 · /resume 이전세션 · /model 모델 · /cost·/status 사용량 · /mcp 서버 · /config 설정 · /init·/review 실행 · Shift+Tab 권한모드",
                      "riven native chat · /clear · /resume · /model · /cost·/status usage · /mcp servers · /config · /init·/review · Shift+Tab permission mode"),
