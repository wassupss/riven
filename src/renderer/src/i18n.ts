...
export const DICT: Record<string, { ko: string; en: string }> = {
  ...
  'pr.back': { ko: '목록으로', en: 'Back to list' },
  'pr.state.open': { ko: '열림', en: 'Open' },
  'pr.state.closed': { ko: '닫힘', en: 'Closed' },
  'pr.state.all': { ko: '전체', en: 'All' },
  'pr.merged': { ko: '병합됨', en: 'Merged' },
  'pr.closed': { ko: '닫힘', en: 'Closed' },
  'pr.createTitle': { ko: '{branch} 브랜치로 PR 만들기', en: 'New pull request from {branch}' },
  'pr.titlePlaceholder': { ko: 'PR 제목', en: 'Pull request title' },
  'pr.bodyPlaceholder': { ko: '설명 (선택)…', en: 'Description (optional)…' },
  'pr.basePlaceholder': { ko: '대상 브랜치 (비우면 기본 브랜치)', en: 'Base branch (default if empty)' },
  'pr.pushBranch': { ko: '{branch} 푸시하고 다시 시도', en: 'Push {branch} and retry' },
  'pr.createWeb': { ko: 'GitHub에서 작성', en: 'Use GitHub' },
  'pr.nCommits': { ko: '커밋 {n}개', en: '{n} commits' },
  'pr.tab.conversation': { ko: '대화', en: 'Conversation' },
  'pr.tab.files': { ko: '변경 파일', en: 'Files' },
  'pr.openThreads': { ko: '해결 안 된 스레드', en: 'unresolved threads' },
  'pr.opened': { ko: '님이 작성', en: 'opened this' },
  'pr.commented': { ko: '코멘트', en: 'commented' },
  'pr.reviewed': { ko: '리뷰', en: 'reviewed' },
  'pr.dismissed': { ko: '리뷰 취소됨', en: 'dismissed' },
  'pr.noDescription': { ko: '설명이 없어요.', en: 'No description.' },
  'pr.noConversation': { ko: '아직 리뷰나 코멘트가 없어요. 줄 단위 코멘트는 변경 파일 탭에 있어요.', en: 'No reviews or comments yet. Line comments are on the Files tab.' },
  'pr.templateUsed': { ko: '저장소 PR 템플릿 적용됨', en: "repo's PR template" },
  'pr.notPushed': { ko: '아직 푸시되지 않은 브랜치', en: 'branch not pushed yet' },
  'pr.nFiles': { ko: '파일 {n}개', en: '{n} files' },
  'pr.conflicting': { ko: '충돌', en: 'Conflicts' },
  'pr.resolved': { ko: '해결됨', en: 'Resolved' },
  'pr.outdated': { ko: '오래된 위치', en: 'Outdated' },
  'pr.resolve': { ko: '해결 처리', en: 'Resolve' },
  'pr.unresolve': { ko: '해결 취소', en: 'Unresolve' },
  'pr.reply': { ko: '답글', en: 'Reply' },
  'pr.replyPlaceholder': { ko: '답글을 입력하세요…', en: 'Write a reply…' },
  'pr.commentOnLine': { ko: '이 줄에 코멘트', en: 'Comment on this line' },
  'pr.commentPlaceholder': { ko: '이 줄에 남길 코멘트…', en: 'Comment on this line…' },
  'pr.addComment': { ko: '코멘트 추가', en: 'Add comment' },
  'pr.pendingComments': { ko: '대기 중인 코멘트 {n}개', en: '{n} pending comments' },
  'pr.reviewPlaceholder': { ko: '리뷰 내용 (선택)…', en: 'Review summary (optional)…' },
  'pr.comment': { ko: '코멘트', en: 'Comment' },
  'pr.requestChanges': { ko: '변경 요청', en: 'Request changes' },
  ...
  'pr.pending': { ko: '작성 중', en: 'Pending' },
  'pr.commentOnLineN': { ko: '{n}번 줄 ({side})에 코멘트', en: 'Comment on line {n} ({side})' },
  'pr.submitHint': { ko: 'PR 패널에서 리뷰를 제출하면 함께 전송돼요', en: 'Sent when you submit the review in the PR panel' },
  ...
  'usage.cli.claude': { ko: 'Claude Code', en: 'Claude Code' },
  'usage.cli.codex': { ko: 'Codex', en: 'Codex' },
  'usage.thisWorkspace': { ko: '이 워크스페이스', en: 'this workspace' },
  'usage.noData': { ko: '없음', en: 'none' },
  'usage.noneToday': { ko: '오늘 사용 없음', en: 'nothing today' },
  'usage.stale': { ko: '최근에 읽은 값 (한도 조회가 일시적으로 제한됨)', en: 'last known (usage endpoint rate limited)' },
  'usage.noLimits': { ko: '플랜 한도 정보 없음', en: 'no plan limits reported' },
  'usage.codexWindow': { ko: '{d}일 창', en: '{d}-day window' },
  ...
  'usage.resetIn': { ko: '{t} 후 초기화', en: 'resets in {t}' },
  'usage.span5h': { ko: '5시간', en: '5h' },
  'usage.span7d': { ko: '7일', en: '7d' },
  'usage.spanDays': { ko: '{d}일', en: '{d}d' },
  'usage.windowShort': { ko: '기간', en: 'Window' },
  'usage.todayShort': { ko: '오늘', en: 'Today' },
  'usage.tokens': { ko: '{n} 토큰', en: '{n} tokens' },
  'usage.showUsed': { ko: '사용', en: 'Used' },
  'usage.showLeft': { ko: '남음', en: 'Left' },
  'usage.estimate': { ko: '로컬 로그 기반 · API 가격 추정', en: 'Local logs · estimated at API rates' },
  ...
  'port.openApi': { ko: 'API 클라이언트에서 열기', en: 'Open in API client' },
  'port.openBrowser': { ko: '브라우저 패널에서 열기', en: 'Open in browser panel' },
  'port.openExternal': { ko: '외부 브라우저에서 열기', en: 'Open in system browser' },
  ...
  'settings.petOnTop': { ko: '항상 위에 두기', en: 'Keep on top' },
  'settings.petOnTopDesc': {
    ko: '다른 앱 위로 항상 올라옵니다. 끄면 보통 창처럼 뒤로 갑니다.',
    en: 'Floats above other apps. Off lets it fall behind them like any window.'
  },
  'pet.default.name': { ko: '이름 없음', en: 'Unnamed' },
  'pet.stage.egg': { ko: '알', en: 'Egg' },
  'pet.stage.hatchling': { ko: '부화체', en: 'Hatchling' },
  'pet.stage.child': { ko: '아이', en: 'Child' },
  'pet.stage.teen': { ko: '청소년', en: 'Teen' },
  'pet.stage.adult': { ko: '성체', en: 'Adult' },
  'pet.species.cat': { ko: '고양이', en: 'Cat' },
  'pet.species.rabbit': { ko: '토끼', en: 'Rabbit' },
  'pet.species.bird': { ko: '새', en: 'Bird' },
  'pet.species.fish': { ko: '물고기', en: 'Fish' },
  'pet.species.turtle': { ko: '거북', en: 'Turtle' },
  'pet.species.bug': { ko: '벌레', en: 'Bug' },
  'pet.species.dog': { ko: '강아지', en: 'Dog' },
  'pet.species.hamster': { ko: '햄스터', en: 'Hamster' },
  'pet.species.penguin': { ko: '펭귄', en: 'Penguin' },
  'pet.species.frog': { ko: '개구리', en: 'Frog' },
  'pet.species.crab': { ko: '게', en: 'Crab' },
  'pet.species.dragon': { ko: '용', en: 'Dragon' },
  'pet.stat.species': { ko: '종', en: 'Strain' },
  'pet.form.radiant': { ko: '광휘', en: 'Radiant' },
  'pet.form.sturdy': { ko: '견실', en: 'Sturdy' },
  'pet.form.titan': { ko: '거구', en: 'Titan' },
  'pet.form.wraith': { ko: '망령', en: 'Wraith' },
  'pet.mood.happy': { ko: '신났어요', en: 'Delighted' },
  'pet.mood.ok': { ko: '괜찮아요', en: 'Content' },
  'pet.mood.hungry': { ko: '배고파요', en: 'Hungry' },
  'pet.mood.sad': { ko: '시무룩해요', en: 'Miserable' },
  'pet.gauge.fullness': { ko: '밥', en: 'FOOD' },
  'pet.gauge.mood': { ko: '기분', en: 'MOOD' },
  'pet.show': { ko: '리븐펫 보이기', en: 'Show RivenPet' },
  
  'pet.hideCmd': { ko: '리븐펫 숨기기', en: 'Hide RivenPet' },
  ...
  'pet.mode.char': { ko: '리븐펫', en: 'PET' },
  'pet.mode.stats': { ko: '상태', en: 'STATUS' },
  'pet.mode.graph': { ko: '먹이 기록', en: 'FEED LOG' },
  'pet.mode.album': { ko: '도감', en: 'ALBUM' },
  'pet.mode.settings': { ko: '설정', en: 'SETUP' },
  'pet.mode.clock': { ko: '시계', en: 'CLOCK' },
  'pet.mode.talk': { ko: '대화', en: 'TALK' },
  'pet.clock.reset': { ko: '{in} 뒤 한도 리셋', en: 'limit resets in {in}' },
  'pet.stat.limit': { ko: '남은 한도', en: 'Plan left' },
  'pet.stat.limitValue': { ko: '{left}% · {in} 뒤 리셋', en: '{left}% · resets in {in}' },
  // ---- what it announces on its own ----
  'pet.notice.done': { ko: '{where}에서 끝났어!', en: 'Done in {where}!' },
  'pet.notice.failed': { ko: '{where}에서 실패했어', en: 'Failed in {where}' },
  'pet.say.swamped': { ko: '{n}개나 돌아가는 중!', en: '{n} jobs at once!' },
  'pet.say.limit': { ko: '한도 {left}% 남았어', en: 'only {left}% of the plan left' },
  // ---- talking to it ----
  'pet.talk.label': { ko: '말 걸기', en: 'Talk' },
  'pet.talk.prompt': {
    ko: '뭐든 물어보세요 — 지금 바빠? / 뭐 먹었어? / 한도 남았어?',
    en: 'Ask it something — busy? / what did you eat? / how much plan is left?'
  },
  'pet.talk.placeholder': { ko: '물어보기…', en: 'ask…' },
  'pet.talk.hi': { ko: '안녕!', en: 'hi!' },
  'pet.talk.hiHungry': { ko: '안녕… 배고파', en: "hi… I'm hungry" },
  'pet.talk.food': { ko: '오늘 {tokens} 먹었어. {flavor}가 {pct}%', en: 'ate {tokens} today — {pct}% {flavor}' },
  'pet.talk.foodNone': { ko: '오늘은 아직 아무것도 못 먹었어', en: 'nothing to eat yet today' },
  'pet.talk.busy': { ko: '{where}에서 {n}개 돌아가는 중', en: '{n} running in {where}' },
  'pet.talk.busyNone': { ko: '지금은 다 조용해', en: 'all quiet right now' },
  'pet.talk.finished': { ko: '{where}에서 {ago} 전에 끝났어', en: 'finished in {where} {ago} ago' },
  'pet.talk.finishedNone': { ko: '아직 끝난 게 없어', en: 'nothing has finished yet' },
  'pet.talk.failed': { ko: '{where}에서 실패했어. {ago} 전에', en: 'failed in {where}, {ago} ago' },
  'pet.talk.limit': { ko: '한도 {left}% 남았고 {in} 뒤에 리셋돼', en: '{left}% left, resets in {in}' },
  'pet.talk.limitNoReset': { ko: '한도 {left}% 남았어', en: '{left}% of the plan left' },
  'pet.talk.limitNone': { ko: '한도는 나도 몰라', en: "I don't know the plan limit" },
  'pet.talk.files': { ko: '오늘 파일 {n}개 바뀌었어', en: '{n} files changed today' },
  'pet.talk.filesNone': { ko: '오늘 바뀐 파일은 없어', en: 'no files changed today' },
  'pet.talk.self': { ko: '{species} {stage}이고 태어난 지 {age}. 지금은 {mood}', en: 'a {species} {stage}, {age} old, and {mood}' },
  'pet.talk.andMore': { ko: '{first} 외 {n}곳', en: '{first} and {n} more' },
  'pet.talk.help': {
    ko: '바쁜지 · 뭐 먹었는지 · 뭐 끝났는지 · 한도 · 바뀐 파일 · 내 상태',
    en: 'what is running · what I ate · what finished · plan left · files changed · how I am'
  },
  'pet.talk.dunno': { ko: '그건 잘 모르겠어', en: "I don't know that one" },
  'pet.stat.name': { ko: '이름', en: 'Name' },
  'pet.stat.stage': { ko: '단계', en: 'Stage' },
  'pet.stat.next': { ko: '성장', en: 'Growth' },
  'pet.stat.games': { ko: '놀이', en: 'Games' },
  'pet.stat.gamesValue': { ko: '{n}판 {w}승', en: '{w}W / {n}' },
  'pet.graph.empty': { ko: '이번 주는 아직 먹은 게 없어요', en: 'Nothing eaten this week' },
  'pet.graph.peak': { ko: '최대 {n}알', en: 'peak {n}' },
  'pet.graph.week': { ko: '7일 {n}알', en: '7d {n}' },
  'pet.graph.today': { ko: '오늘 {n}알', en: '{n} today' },
  'pet.graph.day': { ko: '{day} · {n}알', en: '{day} · {n} kibble' },
  'pet.album.empty': { ko: '아직 떠나보낸 아이가 없어요', en: 'No past pets yet' },
  'pet.album.kibble': { ko: '알', en: ' kibble' },
  'pet.clean': { ko: '치우기', en: 'Clean up' },
  'pet.cleaned': { ko: '깨끗해졌다!', en: 'All clean!' },
  'pet.medicine': { ko: '약 주기', en: 'Medicine' },
  'pet.cured': { ko: '좀 나아졌다', en: 'Feeling better' },
  'pet.patted': { ko: '기분 좋아!', en: 'That is nice' },
  'pet.play': { ko: '놀아주기', en: 'Play' },
  'pet.play.title': { ko: '어느 쪽?', en: 'Which way?' },
  'pet.play.hint': { ko: '방향을 맞혀보세요', en: 'Guess the side' },
  'pet.play.pick': { ko: '고르는 중…', en: 'Guessing…' },
  'pet.play.left': { ko: '왼쪽', en: 'Left' },
  'pet.play.right': { ko: '오른쪽', en: 'Right' },
  'pet.play.win': { ko: '맞혔다!', en: 'You got it!' },
  'pet.play.lose': { ko: '아쉽다!', en: 'Not this time' },
  'pet.play.declined': { ko: '지금은 놀 기분이 아니에요', en: 'Not in the mood right now' },
  'pet.mood.sick': { ko: '아파요', en: 'Sick' },
  'pet.mood.asleep': { ko: '자는 중', en: 'Asleep' },
  'pet.evolved': { ko: '{stage} 됐다!', en: 'Grew into a {stage}!' },
  'pet.say.sleep': { ko: '쿨…', en: 'zzz…' },
  'pet.say.sick': { ko: '아파…', en: 'I feel awful…' },
  'pet.say.eat': { ko: '냠냠', en: 'nom nom' },
  'pet.say.dirty': { ko: '치워줘!', en: 'clean up!' },
  'pet.say.hungry': { ko: '배고파', en: "I'm hungry" },
  'pet.say.bored': { ko: '심심해', en: "I'm bored" },
  'pet.stat.diet': { ko: '입맛', en: 'Taste' },
  'pet.stat.dietValue': { ko: '{flavor} {pct}%', en: '{flavor} {pct}%' },
  'pet.stat.story': { ko: '거쳐온 단계', en: 'Stages' },
  'pet.flavor.opus': { ko: '오푸스', en: 'Opus' },
  'pet.flavor.sonnet': { ko: '소네트', en: 'Sonnet' },
  'pet.flavor.haiku': { ko: '하이쿠', en: 'Haiku' },
  'pet.flavor.codex': { ko: '코덱스', en: 'Codex' },
  'pet.flavor.other': { ko: '잡식', en: 'Mixed' },
  'pet.mode.awards': { ko: '업적', en: 'AWARDS' },
  'pet.back': { ko: '나가기', en: 'Back' },
  'pet.key.select': { ko: 'A · 아이콘 이동', en: 'A · move the highlight' },
  'pet.key.confirm': { ko: 'B · 실행', en: 'B · do it' },
  'pet.key.clock': { ko: 'B · 시계', en: 'B · clock' },
  'pet.key.back': { ko: 'C · 취소 / 나가기', en: 'C · cancel / back' },
  'pet.play.went.left': { ko: '왼쪽으로 갔다', en: 'went left' },
  'pet.play.went.right': { ko: '오른쪽으로 갔다', en: 'went right' },
  'pet.clock.age': { ko: '태어난 지 {age}', en: '{age} old' },
  'pet.settings': { ko: '설정', en: 'Setup' },
  'pet.settings.name': { ko: '이름', en: 'Name' },
  'pet.settings.noName': { ko: '짓기', en: 'set' },
  'pet.settings.where': { ko: '있는 곳', en: 'Lives' },
  'pet.settings.inside': { ko: '앱 안 · 꺼내기', en: 'in app · pop out' },
  'pet.settings.outside': { ko: '앱 밖 · 되돌리기', en: 'outside · put back' },
  'pet.settings.onTop': { ko: '항상 위', en: 'On top' },
  'pet.settings.onTopOn': { ko: '켬', en: 'on' },
  'pet.settings.onTopOff': { ko: '끔', en: 'off' },
  'pet.settings.size': { ko: '크기', en: 'Size' },
  'pet.size.full': { ko: '게임기', en: 'Device' },
  'pet.size.screen': { ko: '화면', en: 'Screen' },
  'pet.size.bare': { ko: '캐릭터', en: 'Pet' },
  'pet.settings.hide': { ko: '보이기', en: 'Visible' },
  'pet.settings.hideDo': { ko: '숨기기', en: 'hide' },
  'pet.settings.restart': { ko: '처음부터', en: 'Start over' },
  'pet.settings.restartDo': { ko: '새 알', en: 'new egg' },
  'pet.say.egg': { ko: '아직 알이에요', en: 'Still an egg' },
  'pet.say.alreadyClean': { ko: '이미 깨끗해요', en: 'Already clean' },
  'pet.say.notIll': { ko: '아프지 않아요', en: 'Not ill' },
  'pet.award.hatch': { ko: '알에서 깨어남', en: 'Hatched' },
  'pet.award.grown': { ko: '성체가 됨', en: 'Fully grown' },
  'pet.award.million': { ko: '100만 토큰', en: '1M tokens' },
  'pet.award.tenMillion': { ko: '1000만 토큰', en: '10M tokens' },
  'pet.award.tidy': { ko: '한 번도 안 아픔', en: 'Never once ill' },
  'pet.award.devoted': { ko: '거의 안 굶김', en: 'Barely ever hungry' },
  'pet.award.streak': { ko: '7일 연속 먹임', en: 'Fed seven days running' },
  'pet.award.playful': { ko: '10판 놀아줌', en: 'Played ten rounds' },
  'pet.award.lucky': { ko: '5승', en: 'Five wins' },
  'pet.award.keeper': { ko: '도감 3마리', en: 'Three in the album' },
  'pet.award.strains': { ko: '서로 다른 종 3종', en: 'Three different strains' },
  'pet.stat.tokens': { ko: '먹은 토큰', en: 'Tokens eaten' },
  'pet.stat.kibble': { ko: '먹은 먹이', en: 'Kibble eaten' },
  'pet.stat.age': { ko: '나이', en: 'Age' },
  'pet.stat.neglect': { ko: '굶긴 시간', en: 'Left hungry' },
  'pet.stat.noNeglect': { ko: '없음', en: 'none' },
  'pet.egg.waiting': { ko: '부화를 기다려요', en: 'Waiting to hatch' },
  'pet.stat.lastMeal': { ko: '마지막 식사', en: 'Last meal' },
  'pet.toNext': { ko: '다음 단계까지 {n}알', en: '{n} kibble to grow' },
  'pet.grown': { ko: '다 자랐어요', en: 'Fully grown' },
  'pet.pet': { ko: '쓰다듬기', en: 'Pet' },
  'pet.rename': { ko: '이름 바꾸기', en: 'Rename' },
  'pet.renameTitle': { ko: '이름을 지어주세요', en: 'Name your pet' },
  'pet.reset': { ko: '새 알부터 다시', en: 'Start over' },
  'pet.resetConfirm': {
    ko: '지금까지 키운 걸 버리고 새 알부터 시작할까요?',
    en: 'Abandon this pet and start again from an egg?'
  },
  'pet.hint': {
    ko: '에이전트가 쓴 토큰 {n}개가 먹이 한 알이 됩니다. 캐시를 다시 읽은 분량은 세지 않아요.',
    en: "Every {n} tokens your agents spend become one kibble. Re-read cache doesn't count."
  },
  'pet.never': { ko: '아직 없음', en: 'Never' },
  'pet.dur.now': { ko: '방금', en: 'just now' },
  'pet.dur.d': { ko: '{n}일', en: '{n}d' },
  'pet.dur.h': { ko: '{n}시간', en: '{n}h' },
  'pet.dur.m': { ko: '{n}분', en: '{n}m' },
